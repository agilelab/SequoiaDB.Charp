...
namespace SequoiaDB.Driver.Linq
{
    ...
    /// </summary>
    public class SequoiaQueryProvider : IQueryProvider
    {
        // private fields
        ...
        public IQueryable<T> CreateQuery<T>(Expression expression)
        {
            ...
            return new SequoiaQueryable<T>(this, expression);
        }
        ...
        public IQueryable CreateQuery(Expression expression)
        {
            ...
            try
            {
                var queryableType = typeof(SequoiaQueryable<>).MakeGenericType(elementType);
