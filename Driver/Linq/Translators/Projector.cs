...
namespace SequoiaDB.Driver.Linq
{
    ...
    {
        // private fields
        private readonly DBCursor _cursor;
        ...
        public IdentityProjector(DBCursor cursor)
        {
            _cursor = cursor;
        }
    ...
    {
        // private fields
        private DBCursor<TSource> _cursor;
        ...
        public Projector(DBCursor<TSource> cursor, Func<TSource, TResult> projection)
        {
            _cursor = cursor;
