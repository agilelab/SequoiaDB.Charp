...
namespace SequoiaDB.Driver.Linq
{
    ...
    internal class PredicateTranslator
    {
        ...
        public ISequoiaQuery BuildQuery(Expression expression)
        {
            ISequoiaQuery query = null;
        ...
        // private methods
        private ISequoiaQuery BuildAndAlsoQuery(BinaryExpression binaryExpression)
        {
            return Query.And(BuildQuery(binaryExpression.Left), BuildQuery(binaryExpression.Right));
        }

        private ISequoiaQuery BuildAndQuery(BinaryExpression binaryExpression)
        {
        ...
        private ISequoiaQuery BuildAnyQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildArrayLengthQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
        ...
        private ISequoiaQuery BuildBooleanQuery(bool value)
        {
            if (value)
            {
        ...
        private ISequoiaQuery BuildBooleanQuery(Expression expression)
        {
        ...
        private ISequoiaQuery BuildComparisonQuery(BinaryExpression binaryExpression)
        {
        ...
        private ISequoiaQuery BuildComparisonQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
            BsonSerializationInfo serializationInfo = null;
        ...
        private ISequoiaQuery BuildConstantQuery(ConstantExpression constantExpression)
        {
            var value = constantExpression.Value;
        ...
        private ISequoiaQuery BuildContainsAllQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildContainsAnyQuery(MethodCallExpression methodCallExpression)
        {
            if (methodCallExpression.Method.DeclaringType == typeof(LinqToMongo))
            {
                var arguments = methodCallExpression.Arguments.ToArray();
        ...
        private ISequoiaQuery BuildContainsKeyQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildContainsQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildEqualsQuery(MethodCallExpression methodCallExpression)
        {
            var arguments = methodCallExpression.Arguments.ToArray();
        ...
        private ISequoiaQuery BuildInQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildInjectQuery(MethodCallExpression methodCallExpression)
        {
            if (methodCallExpression.Method.DeclaringType == typeof(LinqToMongo))
            {
                var arguments = methodCallExpression.Arguments.ToArray();
                if (arguments.Length == 1)
                {
                    ...
                    {
                        return (ISequoiaQuery)queryExpression.Value;
                    }
                }
            }
            return null;
        ...
        private ISequoiaQuery BuildIsMatchQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildIsNullOrEmptyQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildMethodCallQuery(MethodCallExpression methodCallExpression)
        {
        ...
        private ISequoiaQuery BuildModQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
        ...
        private ISequoiaQuery BuildNotQuery(UnaryExpression unaryExpression)
        {
            var queryDocument = new QueryDocument(BuildQuery(unaryExpression.Operand).ToBsonDocument());
            return Query.Not(queryDocument);
        }

        private ISequoiaQuery BuildOrElseQuery(BinaryExpression binaryExpression)
        {
            return Query.Or(BuildQuery(binaryExpression.Left), BuildQuery(binaryExpression.Right));
        }

        private ISequoiaQuery BuildOrQuery(BinaryExpression binaryExpression)
        {
            if (binaryExpression.Left.Type == typeof(bool) && binaryExpression.Right.Type == typeof(bool))
            {
        ...
        private ISequoiaQuery BuildStringIndexOfQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
        ...
        private ISequoiaQuery BuildStringIndexQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
            var unaryExpression = variableExpression as UnaryExpression;
        ...
        private ISequoiaQuery BuildStringLengthQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
            if (constantExpression.Type != typeof(int))
            {
                return null;
        ...
        private ISequoiaQuery BuildStringCaseInsensitiveComparisonQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
        ...
        private ISequoiaQuery BuildStringQuery(MethodCallExpression methodCallExpression)
        {
            if (methodCallExpression.Method.DeclaringType != typeof(string))
            {
                return null;
        ...
        private ISequoiaQuery BuildTypeComparisonQuery(Expression variableExpression, ExpressionType operatorType, ConstantExpression constantExpression)
        {
            if (operatorType != ExpressionType.Equal)
            {
            ...
            if (discriminator.IsBsonArray)
            {
                ...
                var queries = new ISequoiaQuery[discriminatorArray.Count + 1];
        ...
        private ISequoiaQuery BuildTypeIsQuery(TypeBinaryExpression typeBinaryExpression)
        {
