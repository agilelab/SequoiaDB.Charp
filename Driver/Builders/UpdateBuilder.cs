...
using SequoiaDB.Driver.Wrappers;
...
namespace SequoiaDB.Driver.Builders
{
    ...
    public static class Update
    {
        ...
        public static UpdateBuilder Combine(IEnumerable<ISequoiaUpdate> updates)
        {
        ...
        /// <param name="updates">The UpdateBuilders to combine.</param>
        /// <returns>A combined UpdateBuilder.</returns>
        public static UpdateBuilder Combine(params ISequoiaUpdate[] updates)
        {
            return Combine((IEnumerable<ISequoiaUpdate>)updates);
        }
        ...
        /// <returns>The builder (so method calls can be chained).</returns>
        public static UpdateBuilder Pull(string name, ISequoiaQuery query)
        {
        ...
        public static ISequoiaUpdate Replace<TNominalType>(TNominalType document)
        {
        ...
        /// <param name="document">The replacement document.</param>
        /// <returns>An UpdateWrapper.</returns>
        public static ISequoiaUpdate Replace(Type nominalType, object document)
        {
    ...
    /// </summary>
    [Serializable]
    public class UpdateBuilder : BuilderBase, ISequoiaUpdate
    {
        // private fields
        ...
        /// <returns>A combined UpdateBuilder.</returns>
        public UpdateBuilder Combine(ISequoiaUpdate other)
        {
        ...
        /// <param name="query">A query that specifies which elements to remove.</param>
        /// <returns>The builder (so method calls can be chained).</returns>
        public UpdateBuilder Pull(string name, ISequoiaQuery query)
        {
            if (name == null) { throw new ArgumentNullException("name"); }
    ...
    public static class Update<TDocument>
    {
        ...
        /// </returns>
        public static UpdateBuilder<TDocument> Combine(IEnumerable<ISequoiaUpdate> updates)
        {
            if (updates == null) { throw new ArgumentNullException("updates"); }
        ...
        /// A combined UpdateBuilder.
        /// </returns>
        public static UpdateBuilder<TDocument> Combine(params ISequoiaUpdate[] updates)
        {
            return Combine((IEnumerable<ISequoiaUpdate>)updates);
        }
        ...
        /// The builder (so method calls can be chained).
        /// </returns>
        public static UpdateBuilder<TDocument> Pull<TValue>(Expression<Func<TDocument, IEnumerable<TValue>>> memberExpression, Func<QueryBuilder<TValue>, ISequoiaQuery> elementQueryBuilderFunction)
        {
        ...
        /// <param name="document">The replacement document.</param>
        /// <returns>An UpdateWrapper.</returns>
        public static ISequoiaUpdate Replace(TDocument document)
        {
            if (document == null) { throw new ArgumentNullException("document"); }
    ...
    [Serializable]
    public class UpdateBuilder<TDocument> : BuilderBase, ISequoiaUpdate
    {
        // private fields
        ...
        /// <returns>A combined UpdateBuilder.</returns>
        public UpdateBuilder<TDocument> Combine(ISequoiaUpdate other)
        {
        ...
        /// The builder (so method calls can be chained).
        /// </returns>
        public UpdateBuilder<TDocument> Pull<TValue>(Expression<Func<TDocument, IEnumerable<TValue>>> memberExpression, Func<QueryBuilder<TValue>, ISequoiaQuery> elementQueryBuilderFunction)
        {
            if (memberExpression == null)
            {
                throw new ArgumentNullException("memberExpression");
