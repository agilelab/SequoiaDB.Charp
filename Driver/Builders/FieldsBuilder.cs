...
namespace SequoiaDB.Driver.Builders
{
    ...
    public static class Fields
    {
        ...
        /// </summary>
        public static ISequoiaFields Null
        {
            get { return null; }
        }
    ...
    /// </summary>
    [Serializable]
    public class FieldsBuilder : BuilderBase, ISequoiaFields
    {
        // private fields
    ...
    public static class Fields<TDocument>
    {
        ...
        /// <returns>The build (so method calls can be chained).</returns>
        public static FieldsBuilder<TDocument> ElemMatch<TValue>(Expression<Func<TDocument, IEnumerable<TValue>>> memberExpression, Func<QueryBuilder<TValue>, ISequoiaQuery> elementQueryBuilderFunction)
        {
    ...
    /// <typeparam name="TDocument">The type of the document.</typeparam>
    [Serializable]
    public class FieldsBuilder<TDocument> : BuilderBase, ISequoiaFields
    {
        // private fields
        ...
        /// <param name="elementQueryBuilderFunction">The element query builder function.</param>
        /// <returns>The build (so method calls can be chained).</returns>
        public FieldsBuilder<TDocument> ElemMatch<TValue>(Expression<Func<TDocument, IEnumerable<TValue>>> memberExpression, Func<QueryBuilder<TValue>, ISequoiaQuery> elementQueryBuilderFunction)
        {
