...
namespace SequoiaDB.Driver.Builders
{
    ...
    public static class IndexOptions
    {
        ...
        /// </summary>
        public static ISequoiaIndexOptions Null
        {
            get { return null; }
        }
    ...
    /// </summary>
    [Serializable]
    public class IndexOptionsBuilder : BuilderBase, ISequoiaIndexOptions
    {
        // private fields
    ...
    /// <typeparam name="TDocument">The type of the document.</typeparam>
    [Serializable]
    public class IndexOptionsBuilder<TDocument> : BuilderBase, ISequoiaIndexOptions
    {
        // private fields
