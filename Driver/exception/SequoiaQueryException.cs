...
namespace SequoiaDB.Driver
{
    ...
    /// </summary>
    [Serializable]
    public class SequoiaQueryException : SequoiaException
    {
        // private fields
        ...
        public SequoiaQueryException(string message)
            : base(message)
        {
        }
        ...
        public SequoiaQueryException(string message, Exception innerException)
        ...
        public SequoiaQueryException(string message, BsonDocument queryResult)
            : base(message)
        {
        ...
        public SequoiaQueryException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
