...
namespace SequoiaDB.Driver
{
    ...
    /// </summary>
    [Serializable]
    public class SequoiaException : Exception
    {
        // constructors
        /// <summary>
        ...
        public SequoiaException(string message, Exception innerException)
        ...
        public SequoiaException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
