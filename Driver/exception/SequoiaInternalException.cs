...
namespace SequoiaDB.Driver
{
    ...
    /// </summary>
    [Serializable]
    public class SequoiaInternalException : SequoiaException
    {
        // constructors
        /// <summary>
        ...
        public SequoiaInternalException(string message)
            : base(message)
        {
        }
        ...
        public SequoiaInternalException(string message, Exception innerException)
        ...
        public SequoiaInternalException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
